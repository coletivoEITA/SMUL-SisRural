...
class UnidadeProdutivaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $unidadeProdutiva->tiposHorta()->sync(@$data['tiposHorta']);
    ...
    public function update(ProdutorModel $produtor, UnidadeProdutivaModel $unidadeProdutiva, Request $request)
    {
        ...
        SoftDeleteHelper::syncSoftDelete($unidadeProdutiva->TiposHortaWithTrashed(), $unidadeProdutiva->id, @$data['tiposHorta']);
